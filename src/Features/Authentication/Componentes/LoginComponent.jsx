    ...
    return (
      ...
      <form className="flex flex-col gap-4">
        <fieldset>
          ...
          <input
            className="mt-1 w-full rounded-[10px] border border-slate-400 bg-slate-700 px-3 py-2.5 text-white placeholder:text-slate-100 focus:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/40"
            id="email"
            name="email"
            type="email"
        ...
        <fieldset>
          ...
          <section className="flex items-center justify-between gap-3">
            ...
            <Link className="text-sm text-cyan-400 hover:underline" to="/recuperar-contrasena">
        ...
        <button
          className="w-full rounded-full bg-gradient-to-r from-blue-800 via-sky-600 to-cyan-400 px-3 py-3 text-base font-medium text-white shadow-[0_0_18px_rgba(34,211,238,0.3)] transition hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-cyan-300 focus:ring-offset-2 focus:ring-offset-slate-900"
          type="submit"
        >
        ...
        <Link
          className="block w-full rounded-full border border-slate-100 px-3 py-2.5 text-center text-base font-medium text-white transition hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-cyan-300"
          to="/crear-cuenta"
        >
          Cambiar cuenta
        </Link>
