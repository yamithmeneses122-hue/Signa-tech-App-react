        ...
        <section className="grid gap-4 sm:grid-cols-2">
          <article className="rounded-3xl border border-white/8 bg-white/[.025] p-7">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-400">
              Voz, texto y señas pueden convivir en una misma experiencia cuando
              el diseño pone a las personas primero.
            </p>
          </article>
          ...
          <article className="rounded-3xl border border-cyan-300/15 bg-cyan-300/[.045] p-7">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-400">
              SIGNA-TECH se enfoca en comunicación básica y escenarios definidos
