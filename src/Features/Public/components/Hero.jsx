    ...
    <section className="mx-auto grid max-w-[1400px] items-center gap-14 px-5 py-20 lg:grid-cols-[.9fr_1.1fr] lg:px-10 lg:py-28">
      <article>
        <span className="inline-flex items-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-300/[.06] px-4 py-2 text-xs font-bold uppercase tracking-[.18em] text-cyan-200">
          <span className="h-2 w-2 rounded-full bg-cyan-300" /> Tecnología que
          conecta
        </span>
        ...
        <p className="mt-7 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
          SIGNA-TECH propone un puente digital entre voz, texto y Lengua de Señas
          Colombiana para facilitar conversaciones básicas en contextos
        ...
        <section className="mt-9 flex flex-col gap-3 sm:flex-row">
          <Link
            to="/login"
            className="inline-flex min-h-13 items-center justify-center gap-2 rounded-2xl bg-gradient-to-br from-[#00CCFF] to-[#099DCB] px-7 font-bold text-white shadow-[0_18px_45px_rgba(0,204,255,.2)] transition hover:-translate-y-1"
          >
          ...
          <a
            href="#comofunciona"
            className="inline-flex min-h-13 items-center justify-center rounded-2xl border border-white/12 bg-white/[.035] px-7 font-semibold text-slate-200 transition hover:border-cyan-300/40"
          >
            Ver cómo funciona
          </a>
        </section>
          ...
          <section className="rounded-[1.5rem] border border-white/10 bg-[#0b1115] p-5">
            <header className="flex items-center justify-between border-b border-white/8 pb-4">
              <section>
                ...
                <p className="text-xs text-slate-500">Sesión preparada</p>
              </section>
            ...
            <section className="grid gap-4 py-5 sm:grid-cols-2">
              <article className="rounded-2xl border border-cyan-300/15 bg-cyan-300/[.06] p-5">
                ...
                <section className="mt-4 grid h-40 place-items-center rounded-xl border border-dashed border-white/10 bg-black/20">
                  <span className="grid h-20 w-20 place-items-center rounded-full bg-cyan-300/10 text-3xl text-cyan-300">
                    ◉
                  </span>
                </section>
                <p className="mt-3 text-xs text-slate-400">
                  Cámara / micrófono preparado
                </p>
              </article>
              ...
              <article className="rounded-2xl border border-white/8 bg-white/[.025] p-5">
                ...
                <p className="mt-5 rounded-xl bg-white/[.04] p-3 text-sm text-slate-300">
                  Hola, ¿cómo estás?
                </p>
                <p className="mt-3 rounded-xl bg-cyan-300/10 p-3 text-sm text-cyan-100">
